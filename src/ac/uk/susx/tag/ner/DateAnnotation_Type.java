...
public class DateAnnotation_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("ac.uk.susx.tag.ner.DateAnnotation");
  ...
  public String getDate(int addr) {
      ...
      jcas.throwFeatMissing("date", "ac.uk.susx.tag.ner.DateAnnotation");
